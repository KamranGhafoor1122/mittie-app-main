          ...
          _tabChildren = [
            ...
            (productProvider.product.description == null || productProvider.product.description.isEmpty) ? Center(child: Text(getTranslated('no_description_found', context),style: TextStyle(fontSize: ResponsiveHelper.isDesktop(context) ? 20 : 16)))
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text("Product Description",style: TextStyle(fontSize: ResponsiveHelper.isDesktop(context) ? 20 : 16,
              ...
              onTapUrl: (a) async {
                    if(await canLaunchUrlString(a)) {
                      launchUrlString(a, mode: LaunchMode.externalApplication);
                    }
                    return true;
              },
              textStyle: TextStyle(fontSize: ResponsiveHelper.isDesktop(context)? 20 : 12),
            ),
                  ],
                ),
            ...
            (productProvider.productReviewList == null && productProvider.productReviewList.length == 0 )
                ? Center(child:
            Text(getTranslated('no_review_found', context),style: TextStyle(fontSize: ResponsiveHelper.isDesktop(context) ? 20 : 16))
                                          ...
                                          builder: (context, wishList, child) {
                                            ...
                                            /*    Text(
                                                ...
                                                SizedBox(
                                                  ...
                                                  child: InkWell(
                                                    ...
                                                    child: Stack(
                                                      ...
                                                      Center(child: Icon(Icons.shopping_cart_rounded, color: Colors.grey , size: 30)),
                                                      Positioned(
                                                        top: -7, right: -7,
                                                        child: Container(
                                                ...
                                                InkWell(
                                                  ...
                                                  child: Icon(
                                                    wishList.wishIdList.contains(productProvider.product.id) ? Icons.favorite : Icons.favorite_border, size: 25,
                                                    color: wishList.wishIdList.contains(productProvider.product.id) ? Theme.of(context).primaryColor : ColorResources.getGreyColor(context),
                                                  ),
                                                ),
                                              ],
                                            );
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Text("Seeds",style: rubikMedium.copyWith(
                                    color: Theme.of(context).primaryColor,
                                    fontSize: 18
                                  ),),
                                ),
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                        Text(getTranslated('quantity', context), style: rubikMedium.copyWith(fontSize: Dimensions.FONT_SIZE_EXTRA_LARGE)),
                                        ...
                                        Container(
                                          ...
                                          child: Row(children: [
                                            ...
                                            InkWell(
                                              onTap: () => isExistInCart ? _cartProvider.setQuantity(true, _cartModel, 50, context, true, _cartProvider.getCartProductIndex(_cartModel, false, null) ) :  productProvider.setQuantity(true, _stock, context),
                                              child: Container(
                                                  decoration: BoxDecoration(
                                                      borderRadius: BorderRadius.circular(12),
                                                      shape: BoxShape.rectangle,
                                    ...
                                    Expanded(child: Column(
                                      children: [
                                        Text(getTranslated('weight', context), style: rubikMedium.copyWith(fontSize: Dimensions.FONT_SIZE_EXTRA_LARGE)),
                                        /*Expanded(child: SizedBox()),*/
                                        SizedBox(height: 15,),
                                        ...
                                        Container(
                                          ...
                                          child:  Text("10 KG", style: Theme.of(context).textTheme.bodyMedium.
                                          copyWith(
                                              color: Colors.white
                                          ),),
                                        )
