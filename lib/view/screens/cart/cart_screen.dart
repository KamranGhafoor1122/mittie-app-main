...
import 'package:emarket_user/view/screens/checkout/checkout_page.dart';
...
class CartScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: ResponsiveHelper.isDesktop(context)? PreferredSize(child: WebAppBar(), preferredSize: Size.fromHeight(120)) :  CustomAppBar(title: "Shopping Cart", isBackButtonExist: fromDetails),
  ...
  Container buttonView(BuildContext context, double _itemPrice, double _total) {
    return Container(
      width: 1170,
      padding: EdgeInsets.all(Dimensions.PADDING_SIZE_SMALL),
      child: CustomButton(btnTxt: "CHECKOUT", onTap: () {
