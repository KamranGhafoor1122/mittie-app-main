...
class AppConstants {
  static const String APP_NAME = 'Mittie';
  static const double APP_VERSION = 6.2;
  static const String BASE_URL = 'https://admin.mittie.pk/';
  static const String IMAGE_URL = 'https://admin.mittie.pk/storage/app/public/';
  static const String CATEGORY_URI = '/api/v1/categories';
  static const String BANNER_URI = '/api/v1/banners';
  static const String FIELD_OFFICERS_URI = 'api/v1/field-officer/search?coordinates=';
  static const String GET_BRANDS_URI = 'api/v1/brands/getBrands';
  ...
  static List<LanguageModel> languages = [
    ...
    LanguageModel(imageUrl: Images.arabic, languageName: 'Urdu', countryCode: 'PK', languageCode: 'ur'),
  ];
}
